<x-master>
    ...
    <div class="container mt-3">
        ...
        <div class="container">
            <input type="text" name="search" id="search" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600" placeholder="Search..." x-model="searchList">
        </div>
