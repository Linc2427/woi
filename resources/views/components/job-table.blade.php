                ...
                <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td class="border py-4 px-6 flex justify-center">
                        ...
                        <form action="{{ route('perusahaan.destroy', $items->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="focus:outline-none text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Delete</button>
                        </form>
                    </td>
                </tr>
            @endforeach
