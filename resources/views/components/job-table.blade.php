<div class="shadow-lg rounded-lg overflow-hidden mx-4 md:mx-10">
    <table class="min-w-full bg-white border border-gray-200">
        ...
        <tr class="bg-gray-100">
            <td class="border w-1/4 py-4 px-6 text-left text-gray-600 font-bold">No.</td>
        ...
        @foreach($list as $items)
            <tr>
                <td class="border py-4 px-6 border-b border-gray-200">{{ $no++ }}</td>
                <td class="border py-4 px-6 border-b border-gray-200">{{ $items->perusahaan }}</td>
